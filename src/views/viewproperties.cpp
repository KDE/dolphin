...
constexpr DolphinView::Mode ViewModes[] = {DolphinView::IconsView, DolphinView::CompactView, DolphinView::DetailsView, DolphinView::ColumnsView};
}
...
bool ViewProperties::isDefaults() const
{
    ...
    return m_node->viewMode() == defaultProps->viewMode()
        ...
        && m_node->columnsZoomLevel() == defaultProps->columnsZoomLevel()
...
int ViewProperties::zoomLevel(DolphinView::Mode mode) const
{
    ...
    case DolphinView::ColumnsView:
        return m_node->columnsZoomLevel();
    }
    Q_UNREACHABLE();
}
...
void ViewProperties::setZoomLevel(DolphinView::Mode mode, int level)
{
    ...
    case DolphinView::DetailsView:
        ...
        break;
    case DolphinView::ColumnsView:
        m_node->setColumnsZoomLevel(level);
        break;
    }
    update();
}
