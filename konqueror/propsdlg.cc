 ...
 * the rest of the layout management, bug fixes, adaptation to konqueror by
...
Properties::Properties( const char *_url, mode_t _mode ) : QObject(), url(_url), mode(_mode)
{
...
void Properties::emitPropertiesChanged( const QString& _new_name )
{
